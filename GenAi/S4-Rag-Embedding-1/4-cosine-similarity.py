"""
Understanding Cosine Similarity with Gemini Embeddings
...
if __name__ == "__main__":
    print("="*70)
    print("UNDERSTANDING COSINE SIMILARITY (GEMINI)")
    print("="*70)
    ...
    # text2 = 'I love Programming in LLM'
    # sim = compare_texts(text, text2)
    # print(f"\nText 1: '{text}'")
